...
import { MdOutlineDashboardCustomize, MdSecurity } from 'react-icons/md';
...
const SidebarContent = props => {
    ...
    const userImg = `${process.env.REACT_APP_URL_IMG}/img/users/`;
                        ...
                        <>
                            ...
                            <li>
                                <Link to="/dashboard" className="waves-effect">
                                    <MdOutlineDashboardCustomize size={22} className="me-3" />
                                    <span >{props.t("Dashboard")}</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/profile" className="waves-effect">
                                    <AiOutlineUserSwitch size={22} className="me-3" />
