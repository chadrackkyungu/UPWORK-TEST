...
function MyProperties() {
    ...
    const { data, reFetch } = useFetch(`https://security-check-in.herokuapp.com/api/v1/properties`, token);
    ...
    return (
        <div>
            <CardBody>
                ...
                {
                    role === 'admin' ? null :
                        <button className='btn text-white me-4 mb-5' onClick={() => setSmExample(true)}> + Add a new property</button>
                }
                {
            ...
            <Modal show={smExample} onHide={() => setSmExample(false)} size="lg">
                <Modal.Header>
                    <h3> Add a new property </h3>
                </Modal.Header>

                <Modal.Body>
                    <PropertyForm setSmExample={setSmExample} reFetch={reFetch} />
                </Modal.Body>

                <Modal.Footer>
                    <button className='btn text-white' onClick={() => setSmExample(false)}> Close </button>
                </Modal.Footer>
            </Modal>
